 ...
 */
final class Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel extends \Tx_Oelib_Model
{
    /**
     ...
     *
     * @return \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel
     */
     ...
     *
     * @param \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $friend
     *
     * @return void
     */
    public function setFriend(\Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $friend)
    {
     ...
     *
     * @param \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $record
     *
     * @return void
     */
    public function addRelatedRecord(\Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $record)
    {
     ...
     * @return void
     */
    public function addCompositionRecord(\Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingChildModel $model)
    {
     ...
     *
     * @param \Tx_Oelib_List $components \Tx_Oelib_List<\Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingChildModel>
     *
     * @return void
     */
