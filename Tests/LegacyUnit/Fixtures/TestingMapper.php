 ...
 */
class Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingMapper extends \Tx_Oelib_DataMapper
{
    /**
     ...
     */
    protected $relations = [
        'friend' => \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingMapper::class,
        'owner' => \Tx_Oelib_Mapper_FrontEndUser::class,
        'children' => \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingMapper::class,
        'related_records' => \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingMapper::class,
        ...
        'bidirectional' => \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingMapper::class,
    ];
