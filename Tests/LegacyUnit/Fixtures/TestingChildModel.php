 ...
 */
class Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingChildModel extends \Tx_Oelib_Model implements \Tx_Oelib_Interface_Sortable
{
    /**
     ...
     *
     * @return \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel the "parent" data item,
     ...
     *
     * @return \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel the "tx_oelib_parent2" data
     ...
     *
     * @param \Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $parent
     *        the "parent" data item to set
     *
     * @return void
     */
    public function setParent(\Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $parent)
    {
     ...
     * @return void
     */
    public function setParent2(\Tx_Oelib_Tests_LegacyUnit_Fixtures_TestingModel $parent)
    {
